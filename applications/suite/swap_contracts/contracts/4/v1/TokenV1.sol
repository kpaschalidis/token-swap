...
contract MigrationAgentInterface {
    ...
    function setSourceToken(address _sourceToken);

    function updateSupply();

    function sourceToken() returns (address);
}
    ...
    MintableToken
{
    ...
    string public constant symbol = "TV1";
    string public constant name = "TokenV1";
     ...
     * Constructor.
     */
    function Token(address _migrationMaster) {
    ...
    */
    ...
    function setMigrationAgent(address _agent) public onlyMigrationMaster {
        require(
            MigrationAgentInterface(_agent).sourceToken() == address(this)
        );
